...
\input{section-notation-contribution.tex}
...
\section{Algorithm: K-Top Probabilistic Flip Method (K-Top PFM)}
% TODO: change the notation
\label{sec:algorithm}

\input{section-algorithm.tex}

\section{Time Bounds}
\label{sec:timeBounds}

\input{section-time-bound.tex}
